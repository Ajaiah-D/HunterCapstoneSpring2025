      ...
      className={`w-screen text-white`}>
        ...
        <div className="bg-gradient-to-br from-[#AF95F2] to-[#4361FE] opacity-70">
          <div className="center gap-10 p-40 pb-0">
            ...
            <p>
              Sleep is an essential part of our lives, and it plays a crucial role in our overall health and well-being. 
              However, many people struggle with sleep-related issues, such as insomnia, sleep apnea, and restless leg syndrome. 
              These problems can lead to a range of negative consequences, including fatigue, irritability, and difficulty concentrating.
              A sleep analyzer can help identify these issues and provide valuable insights into your sleep patterns.
            </p>
            <p>
        ...
        <div className="p-20 gap-5 text-black">
          <div className="bg-white p-20 rounded-3xl center gap-10">
             <h1 className="text-5xl">Why is not getting enough sleep a bad thing?</h1>
          ...
          <h3 className="text-4xl pb-4 border-b-2 border-[#2C229E]">The Statistics</h3>
          <div className={`center gap-5 text-black`}>
            ...
            <p className="text-right w-[45rem]">
              Source: John Hopkins
            </p>
          </div>
          </div>
