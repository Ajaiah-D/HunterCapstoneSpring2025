    ...
    <section className={`center bg-gradient-to-br from-[#AF95F2] via-[#4361FE] to-[#2C229E] ${heightLength} w-screen text-white gap-8`}>
      <div className="grid gap-8 p-5 sm:mt-15">
        ...
        <div className="text-center grid gap-5">
          ...
          <p> 
            Sleep deprivation and disorder is becoming increasingly prevalent throughtout the world, including the US. 
            According to the American Academy of Sleep Medicine and HCA Healthcare, 54% of Americans and 60% of adolescents
            experience sleep deprivation. Almost 30% have trouble falling asleep (National Health and Nutrition 
            Examination Survey, 2017-2020) and 70 million (about 1/5) of Americans have a sleeping disorder. Due to this,
            almost 80% of adults want to improve their sleep but only 40% of them have sought medical help (Phillips, 2019).
          </p>
        </div>
        <div className="text-center grid gap-10">
          <h1 className="text-6xl">
            Why is sleep debt a bad thing?
          </h1>
